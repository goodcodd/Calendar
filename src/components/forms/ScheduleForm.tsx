"use client" // Indicates client-side execution for Next.js optimization
...
import { formatTimeZoneOffset } from "@/lib/formattes"

type Availability = { // TypeScript type for availability
  startTime: string
  endTime: string
...
export function ScheduleForm({
  ...
  const { // React Hook Form field array operations

...
// Define a schema for the schedule form using Zod
export const scheduleFormSchema = z.object({
  timezone: z.string().min(1, "Required"), // Require a non-empty string for timezone
  availabilities: z
    .array(
      z.object({
        dayOfWeek: z.enum(DAYS_OF_WEEK_IN_ORDER), // Validate day of the week
        startTime: z
          .string()
          .regex(
